...
label = Label(window,textvariable=label_text,font=("consolas",20),bg="#b6d4b9",width=20,height=2)
label.pack()
...
clear = Button(window,text="clear",height=2,width=6,font=35,
                 command=clear)
clear.pack()
